...
const cliniccostsRouter= require('./routes/cliniccostsRouter')
const processRouter= require('./routes/processRouter')
const serviceRouter= require('./routes/serviceRouter')
const patientRouter= require('./routes/patientRouter')
// 3) ROUTES
app.use('/', userRouter);
// app.use('/api/v1.0.0/teeths', teethRouter);
app.use('/api/v1.0.0/cliniccostss', cliniccostsRouter);
app.use('/api/v1.0.0/processs', processRouter);
app.use('/api/v1.0.0/services', serviceRouter);
app.use('/api/v1.0.0/patients', patientRouter);
